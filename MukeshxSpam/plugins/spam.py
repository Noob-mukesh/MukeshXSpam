...
@Mlk.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Mlk2.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Mlk3.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Mlk4.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Mlk5.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Mlk6.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Mlk7.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Mlk8.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Mlk9.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
@Mlk10.on(events.NewMessage(incoming=True, pattern=r"\%sspam(?: |$)(.*)" % hl))
async def spam(e):
    ...
    if e.sender_id in SUDO_USERS:
        ...
        Mlkoel = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        smex = await e.get_reply_message()
        if len(Mlkoel) == 2:
            message = str(Mlkoel[1])
            counter = int(Mlkoel[0])
            if counter > 100:
...
@Mlk.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Mlk2.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Mlk3.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Mlk4.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Mlk5.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Mlk6.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Mlk7.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Mlk8.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Mlk9.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
@Mlk10.on(events.NewMessage(incoming=True, pattern=r"\%sbigspam" % hl))
async def spam(e):
...
@Mlk.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Mlk2.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Mlk3.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Mlk4.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Mlk5.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Mlk6.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Mlk7.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Mlk8.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Mlk9.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
@Mlk10.on(events.NewMessage(incoming=True, pattern=r"\%sdelayspam" % hl))
async def spam(e):
    ...
    if e.sender_id in SUDO_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None)
        smex = await e.get_reply_message()
        Mlkoel = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        Mlkoelsexy = Mlkoel[1:]
        if len(Mlkoelsexy) == 2:
            message = str(Mlkoelsexy[1])
            counter = int(Mlkoelsexy[0])
            sleeptime = float(Mlkoel[0])
            for _ in range(counter):
                async with e.client.action(e.chat_id, "typing"):
                    if e.reply_to_msg_id:
                        await smex.reply(message)
...
@Mlk.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Mlk2.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Mlk3.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Mlk4.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Mlk5.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Mlk6.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Mlk7.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Mlk8.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Mlk9.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
@Mlk10.on(events.NewMessage(incoming=True, pattern=r"\%spornspam(?: |$)(.*)" % hl))
async def pspam(e):
    if e.sender_id in SUDO_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
...
@Mlk.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Mlk2.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Mlk3.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Mlk4.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Mlk5.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Mlk6.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Mlk7.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Mlk8.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Mlk9.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
@Mlk10.on(events.NewMessage(incoming=True, pattern=r"\%shang(?: |$)(.*)" % hl))
async def hang(e):
...
@Mlk.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Mlk2.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Mlk3.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Mlk4.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Mlk5.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Mlk6.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Mlk7.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Mlk8.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Mlk9.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
@Mlk10.on(events.NewMessage(incoming=True, pattern=r"\%spackspam(?: |$)(.*)" % hl))
